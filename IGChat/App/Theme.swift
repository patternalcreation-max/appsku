...
enum Theme {
    ...
    /// Default Me trailing inset (overridden by Settings `meEdgeInset`).
    static let meEdgeInsetDefault: CGFloat = 12
    ...
    static let gradientEnd = Color(red: 0x6B / 255.0, green: 0x3F / 255.0, blue: 0xC7 / 255.0)
    ...
    static let profileButton = Color(red: 0x27/255.0, green: 0x2B/255.0, blue: 0x33/255.0)
}
